...
- `<name>-api-schemas.ts` / `<name>-api-types.ts` — Zod schemas and inferred types for requests, responses and the objects within those
...
- `testing/` — MSW request handlers + mock data (used in Vitest tests and for local dev only)
